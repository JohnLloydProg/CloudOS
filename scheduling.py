...
class Process:
    ...
    def __init__(self, user:User, arrival_time, priority:int=3):
        self.user = user
...
class DownloadProcess(Process):
    ...
    def __init__(self, download_link:str, user:User, file_name:str, arrival_time):
...
class UploadProcess(Process):
    ...
    def __init__(self, firebase_bucket:str, user:User, file_name:str, file:str, arrival_time):
        super().__init__(user, arrival_time)
        self.file_name = file_name
...
class Computer:
    ...
    def add_process(self, process:Process):
        ...
        print(f"Process of type {process.process_type} added to priority {process.priority} queue.")
        ...
        while True:
            ...
            if (self.current_process):
                ...
                if (self.current_process.priority == 3):
                    if (self.multi_level_scheduling[3]["queue"]):
